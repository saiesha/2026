...
export default function Home() {
  ...
  return <>
    <style>{`
      ...
      .closing { background:#f5ffc6; color:#101827; min-height:440px; padding:72px; align-items:center; justify-content:center; text-align:center; }
      .closing::before { content:""; position:absolute; width:280px; height:280px; right:8%; top:50%; transform:translateY(-50%) rotate(12deg); border:1px solid rgba(16,24,39,.12); border-radius:50%; display:block; }
      .closing::after { content:""; position:absolute; width:180px; height:180px; right:calc(8% + 50px); top:50%; transform:translateY(-50%) rotate(-18deg); border:1px solid rgba(104,65,209,.28); display:block; }
      ...
      html[data-theme="dark"] .closing::before { border-color:rgba(180,225,255,.13); }
      html[data-theme="dark"] .closing::after { border-color:rgba(180,225,255,.28); }
      @media (max-width:700px) {
        .closing { min-height:400px; padding:48px 28px; }
        .closing::before { width:220px; height:220px; right:-55px; top:42%; }
        .closing::after { width:140px; height:140px; right:-10px; top:42%; }
      }
    ...
    <main>
      ...
      <section className="closing reveal"><div className="closing-copy"><p className="eyebrow"><span /> 2026</p><h2>That's me,<br /><em>for now.</em></h2><div className="closing-links"><a href="https://github.com/saiesha" target="_blank" rel="noreferrer">GitHub ↗</a><a href="/blog">Writing ↗</a></div></div></section>
